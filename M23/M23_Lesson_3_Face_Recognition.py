# M23 Lesson 3 – Face Recognition
# Short Description: Implementing face detection and recognition using OpenCV and deep learning.

# Activity 1
# Goal: Implement basic face detection using Haar cascades.
# Summary: Detect faces in images and video streams using OpenCV.
import cv2
import numpy as np
