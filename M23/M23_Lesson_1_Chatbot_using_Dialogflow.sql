-- # M23 Lesson 1 – Chatbot using Dialogflow
-- # Short Description: Introduction to building chatbots using Google's Dialogflow platform.

-- # Activity 1
-- # Goal: Create a basic agent in Dialogflow and understand intents.
-- # Summary: Students will set up a new agent and create simple intents for greetings.
