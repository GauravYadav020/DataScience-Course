# M20 Lesson 6 – ANN Implementation using Keras – 2
# Short Description: Training, evaluating, and improving the ANN model.

# Activity 1
# Goal: Train the model and monitor training progress.
# Summary: Use model.fit() and plot training/validation loss.
